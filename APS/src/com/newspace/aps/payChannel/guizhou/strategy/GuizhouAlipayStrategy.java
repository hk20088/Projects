...
//		String payUrl = "http://cn.bing.com/";
		...
		{
			//封装响应参数
			bodyList = PayHandler.fillBodyList(bodyList, PayConfig.PAY_SPQ, PayHandler.getParam(payUrl, Order.PAYTYPE_GUIZHOU_ALIPAY));
			
			//贵阳广电BOSS系统订单号（这里有可能已经被赋了值，比如在处理平遥通道时已经生成了订单号，这里用$隔开，追加到后面）
